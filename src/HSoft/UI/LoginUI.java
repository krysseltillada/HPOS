...
public class LoginUI extends javax.swing.JFrame {
    ...
    static public void updateLog (String description, String date, String time, String username, String type) {
        ...
        if (type.equals("EMPLOYEE")) {
             try {
           Connection conn2 = DriverManager.getConnection ("jdbc:derby://localhost:1527/Kryssel");
           PreparedStatement sql2 = conn2.prepareStatement ("UPDATE TBLEMPLOYEE SET DATELOGIN = ?, TIMELOGIN = ? WHERE USERNAME = ?");
    ...
    private String generateCode () {
       ...
       //rand.nextInt((max - min) + 1) + min;
        ...
        for (;true;) {
           ...
           if ( (generatedNumber <= 90 && generatedNumber >= 65) ||
                 (generatedNumber <= 57 && generatedNumber >= 48)) {
